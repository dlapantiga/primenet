...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap DatePicke--> 
        <!-- <link href="<?php echo base_url();?>assets/js/DatePicker/css/bootstrap.min.css" rel="stylesheet"> 
        <link href="<?php echo base_url();?>assets/js/DatePicker/css/datepicker.css" rel="stylesheet"> -->
        <script type="text/javascript" src="<?php echo base_url();?>assets/js/DatePicker/js/jquery-1.10.2.min.js"></script> 
    ...
    <body>
        ...
        <script src="<?php echo base_url();?>assets/js/DatePicker/js/bootstrap.min.js"></script>
